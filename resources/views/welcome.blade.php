...
{{--        </div>--}}
        ...
        <div class="container pt-2" style="margin-top:50px ">
                ...
                @if (Route::has('login'))
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{ route('login') }}" >
                                    <img src="{{ asset('assets/images/user_login.jpg')}}" style="max-width: 200px;min-height: 220px" class="img-fluid" alt="">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('adminLogin') }}" >
                                        <img src="{{ asset('assets/images/admin_login.jpg')}}" style="max-width: 200px;min-height: 220px" class="img-fluid" alt="">
